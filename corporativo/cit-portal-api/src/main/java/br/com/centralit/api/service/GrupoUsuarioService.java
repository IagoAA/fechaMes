 ...
 * 
 */
public interface GrupoUsuarioService extends GenericService<GrupoUsuario, Long> {
	 ...
	 * @param grupo
	 */
	void verificarRemocaoGrupoUsuario(Grupo grupo);
	 ...
	 * @param entity
	 */
	void verificarRemocaoGrupoUsuarioAtravesDoUsuario(Usuario entity);
