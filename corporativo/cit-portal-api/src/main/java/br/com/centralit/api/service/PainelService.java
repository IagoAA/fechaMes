 ...
 * 
 */
public interface PainelService extends GenericService<Painel, Long> {
	 ...
	 */
	Collection<Painel> findPorUsuario();
	 ...
	 * @param painel
	 */
	Painel salvarDashBoard(Painel painel);
	 ...
	 * @return
	 */
	Painel findPainelDashBoard(Long id);
