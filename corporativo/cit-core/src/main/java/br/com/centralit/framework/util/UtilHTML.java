...
public class UtilHTML {
	...
	public static final String encodeHTML(String string) {
		...
		for (int i = 0; i < length; i++) {
			...
			case 'ú':
			case 'Ú':
				encoded.append("&" + getConvertedChar(c) + "acute;");
				break;
			case 'â':
			case 'Â':
			case 'ê':
			...
			case 'û':
			case 'Û':
				encoded.append("&" + getConvertedChar(c) + "circ;");
				break;
			case 'ã':
			case 'Ã':
			case 'õ':
			case 'Õ':
				encoded.append("&" + getConvertedChar(c) + "tilde;");
				break;
			case 'à':
			case 'À':
			case 'è':
			...
			case 'ù':
			case 'Ù':
				encoded.append("&" + getConvertedChar(c) + "grave;");
				break;
			default:
				encoded.append(c);
				break;
	 ...
	 * @return
	 */
	public static String getConvertedChar(char c) {
		if (c == 'á' || c == 'â' || c == 'ã') {
			return "a";
		}
		if (c == 'à') {
	...
	public static final String removeHTMLFormat(String str) {
