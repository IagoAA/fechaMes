...
citApp.factory('EstruturaOrganizacionalRepository', ['RestangularTabelasCorp', 'AbstractRepository', function (restangularTabelasCorp, AbstractRepository) {
    ...
    function EstruturaOrganizacionalRepository() {
    	...
    	// Listar estruturas organizacionais por nome e organizacao que sejam loja
    	this.listarEstruturasOrganizacionaisLojaPorNomeEOrganizacao = function(value, idOrganizacao) {
    		return restangularTabelasCorp.one(this.route).getList("listarEstruturasOrganizacionaisLojaPorNomeEOrganizacao", {nome : value, idOrganizacao : idOrganizacao}).then();
    	};
